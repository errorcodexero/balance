...
#ifndef xAXIS_CAMERA_H
#define xAXIS_CAMERA_H
 ...
 */
class xAxisCamera : public AxisCameraParams
{
private:
	explicit xAxisCamera(const char *cameraIP);
public:
	virtual ~xAxisCamera();
	static xAxisCamera& GetInstance(const char *cameraIP = NULL);
...
private:
	static int s_ImageStreamTaskFunction(xAxisCamera *thisPtr);
